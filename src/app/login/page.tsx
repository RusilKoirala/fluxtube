        ...
        <div className="min-h-screen bg-black flex items-center justify-center px-6">
            <div className="max-w-md w-full">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-[24px] font-bold text-white mb-1">Sign In</h1>
                    <p className="text-[14px] text-neutral-500">Access your account</p>
                </div>
                ...
                <div className="bg-neutral-900 border border-neutral-800 rounded p-6">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-neutral-500 text-[13px]">
                            ...
                            <Link href='/signup' className="text-[#f5c518] hover:underline font-medium">
                                Sign up
                            </Link>
                        </p>
                    </div>
